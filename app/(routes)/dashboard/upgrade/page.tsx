      ...
      <div className='mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8'>
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8'>
          ...
          <div className='rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12'>
            ...
            <a
              href='#'
              className='mt-8 block rounded-full border border-primary bg-white px-12 py-3 text-center text-sm font-medium text-priamry hover:ring-1 hover:ring-primary focus:outline-none focus:ring active:text-primary'
            >
              Get Started
            </a>
          </div>
